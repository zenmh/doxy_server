...
const createProduct = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (isExist)
        throw new ApiError_1.default(409, "The product is already exist !!");
    const result = yield prisma_1.default.product.create({ data });
    return result;
});
exports.ProductService = { createProduct };
